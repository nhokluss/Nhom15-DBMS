...
namespace DBMS_G15
{
    public partial class OrderForm : Form
    {
        ...
        string DaHuy = "Đã hủy";
        string str = @"Data Source=(local);Initial Catalog=DBMS_Demo;Integrated Security=True";
        ...
        {
            using (SqlConnection connection = new SqlConnection(@"Data Source=(local);Initial Catalog=DBMS_Demo;Integrated Security=True"))
            {
                try
                {
                    connection.Open();
